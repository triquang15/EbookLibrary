...
export const LoanModal: React.FC<{ shelfCurrentLoan: ShelfLoans, mobile: boolean, returnBook: any,
   renewLoan: any}> = (props) => {
    return (
                                    ...
                                    <div className='row'>
                                        <div className='col-2'>
                                            {props.shelfCurrentLoan.book?.image ?
                                                <img src={props.shelfCurrentLoan.book?.image} 
                                                    width='56' height='87' alt='Book'/>
                                                :
                                                <img src={require('./../../../Images/BooksImages/new-book-1.jpg')}
                                                    width='56' height='87' alt='Book'/>
                                            }
                                        </div>
